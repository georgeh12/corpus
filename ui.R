...
shinyUI(
	pageWithSidebar(
		headerPanel("Text Analysis Score: ", pre(textOutput("readability.score"))),
      ...
      tags$textarea(id="text", rows=30, cols=35, maxlength=10000,autofocus="autofocus",
        onfocus="if(this.value==\"(Paste your text here. Text limit is 10000 characters, but should at least have 100 words.)\") this.value=window.location;",
